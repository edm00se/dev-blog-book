...
<a href="{{ book.site }}/images/post_images/aPartialRefreshCall_ViewAndPager.png" data-toggle="tooltip" title="a stock partial refresh from a view pager"><img src="{{ book.site }}/images/post_images/aPartialRefreshCall_ViewAndPager.png" alt="a stock partial refresh from a view pager" /></a>
...
<a href="{{ book.site }}/images/post_images/angular_ngrepeat_noNetworkCalls_scrubbed.gif" data-toggle="tooltip" title="paging with Angular"><img src="{{ book.site }}/images/post_images/angular_ngrepeat_noNetworkCalls_scrubbed.gif" alt="paging with Angular" /></a>
...
<a href="{{ book.site }}/images/post_images/angular_ngrepeat_liveSearch_scrubbed.gif" data-toggle="tooltip" title="searching a data array in Angular"><img src="{{ book.site }}/images/post_images/angular_ngrepeat_liveSearch_scrubbed.gif" alt="searching a data array in Angular" /></a>
...
<a href="{{ book.site }}/images/post_images/keanu_front-back-segregation.jpg" data-toggle="tooltip" title="make a better Domino app!"><img src="{{ book.site }}/images/post_images/keanu_front-back-segregation.jpg" alt="make a better Domino app!" /></a>

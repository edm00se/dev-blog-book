...
![a stock partial refresh from a view pager]({{ book.site }}/images/post_images/aPartialRefreshCall_ViewAndPager.png)
...
![a stock partial refresh from a view pager network transfer time]({{ book.site }}/images/post_images/aPartialRefreshCall_timeAndMoney.png)
...
![paging with Angular]({{ book.site }}/images/post_images/angular_ngrepeat_noNetworkCalls_scrubbed.gif)
...
![make a better Domino app!]({{ book.site }}/images/post_images/keanu_front-back-segregation.jpg)
